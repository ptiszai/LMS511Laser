...
{
    public class LMDscandataEventArgs : EventArgs
    {
        /// <summary>        
        ///  ScanData  : LMDscandata_R class
        /// </summary>
        /// <remarks>
        ///  Output of measured values of one scan
        /// </remarks>
        private LMDscandata_R _scanData;

        public LMDscandataEventArgs(LMDscandata_R scanData)
        {
            this._scanData = scanData;
        }

        public LMDscandata_R ScanData
        {
            get
            {
                return _scanData;
